...
def test_lazy_separableconv1d():
    input = torch.randn(4, 10, 100)
    m = nn.LazySeparableConv1d(30, 3, padding=1)
    output = m(input)

    assert output.shape == torch.Size([4, 30, 100])


def test_lazy_separableconv2d():
    input = torch.randn(4, 10, 100, 100)
    m = nn.LazySeparableConv2d(30, 3, padding=1)
    output = m(input)

    assert output.shape == torch.Size([4, 30, 100, 100])


def test_lazy_separableconv3d():
    input = torch.randn(4, 10, 100, 100, 100)
    m = nn.LazySeparableConv3d(30, 3, padding=1)
    output = m(input)
